...
switch ($_GET['P']) {
	...
	case 'listBarcelona': IsUserLoggedIn() ? require_once PROTECTED_DIR.'cities/barcelona.php' : header('Location: index.php'); break;

	case 'listParis': IsUserLoggedIn()? require_once PROTECTED_DIR.'cities/paris.php' : header('Location: index.php'); break;
